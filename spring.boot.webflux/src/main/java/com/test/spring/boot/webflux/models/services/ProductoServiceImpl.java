package com.test.spring.boot.webflux.models.services;

import com.test.spring.boot.webflux.models.dao.ICatagoriaRepository;
...
public class ProductoServiceImpl implements IProductoService{
    ...
    @Autowired
    IProductosRepository dao;
    @Autowired
    private ICatagoriaRepository categoriaDao;
